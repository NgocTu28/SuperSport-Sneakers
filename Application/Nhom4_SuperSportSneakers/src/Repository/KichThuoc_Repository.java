...
public class KichThuoc_Repository {
    ...
    public ArrayList<KichThuoc> getToAllKichThuoc() {
        ...
        try {
            ...
            while (rs.next()) {
                listKichThuoc.add(new KichThuoc(rs.getLong(1), rs.getString(2), rs.getString(3), rs.getInt(4)));
            }
        } catch (Exception e) {
    ...
    public List<KichThuoc> get(int page, int limt) {
        ...
        try {
            ...
            while (rs.next()) {
                list.add(new KichThuoc(rs.getLong(1), rs.getString(2), rs.getString(3), rs.getInt(4)));
            }
        } catch (Exception e) {
            System.out.println(e);
        }
...
// Đếm tổng số bản ghi 
    ...
    public List<KichThuoc> search_KichThuoc(String text) {
        ...
        try {
            ...
            ResultSet rs = ps.executeQuery();
            while (rs.next()) {
                listSearch.add(new KichThuoc(rs.getString(1), rs.getString(2), rs.getInt(3)));
            }
        } catch (Exception e) {
